...
class ViewController: UIViewController {
    ...
    @IBAction func enableBedtime(_ sender: UISwitch) {
        ...
        let trackStartColor: UIColor = UIColor(red: 0.976, green: 0.645, blue: 0.068, alpha: 1.000)
        let trackEndColor: UIColor = UIColor(red: 0.976, green: 0.645, blue: 0.068, alpha: 1.000)
        ...
        self.bedtimeClockView.changePalette(
            ...
            trackStartColor: !sender.isOn ? disabledColor : trackStartColor,
            trackEndColor: !sender.isOn ? disabledColor : trackEndColor,
